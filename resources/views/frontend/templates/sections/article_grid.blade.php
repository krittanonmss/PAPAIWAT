...
<section class="bg-slate-950 px-4 py-16">
    <div class="mx-auto max-w-7xl">
        <div class="mb-7 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            ...
            <a href="{{ url('/article-list') }}" class="inline-flex items-center justify-center rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-2.5 text-sm font-medium text-slate-300 transition hover:bg-white/10 hover:text-white">ดูทั้งหมด</a>
        </div>
