                            ...
                            <tr>
                                ...
                                <td class="px-5 py-4 align-top">
                                    <div class="flex justify-end gap-2">
                                        ...
                                        <form method="POST" action="{{ route('admin.interactions.comments.ban-visitor', $comment) }}" onsubmit="return confirm('ban visitor นี้หรือไม่?');">
                                            @csrf
                                            @method('PATCH')
                                        ...
                                        <form method="POST" action="{{ route('admin.interactions.comments.ban-ip', $comment) }}" onsubmit="return confirm('ban IP นี้หรือไม่?');">
                                            @csrf
                                            @method('PATCH')
