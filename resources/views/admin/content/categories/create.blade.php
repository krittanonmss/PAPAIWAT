<x-layouts.admin title="สร้างหมวดหมู่" header="Create Category">
        ...
        <div class="overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-slate-900 via-slate-900 to-indigo-950 shadow-xl shadow-slate-950/30">
            <div class="flex flex-col gap-6 p-6 lg:flex-row lg:items-center lg:justify-between">
                <div class="max-w-2xl">
                    ...
                    <h1 class="text-2xl font-bold text-white">สร้างหมวดหมู่</h1>

                    <p class="mt-2 text-sm leading-6 text-slate-400">
                        เพิ่มหมวดหมู่ใหม่สำหรับจัดกลุ่มวัด บทความ หรือเนื้อหาอื่นในระบบ
                    </p>
                </div>
                    ...
                    <div class="rounded-3xl border border-white/10 bg-white/[0.04] p-5 shadow-xl shadow-slate-950/30 backdrop-blur">
                        ...
                        <div class="mt-4 space-y-3">
                            <div class="rounded-2xl border border-white/10 bg-slate-950/40 p-4">
                                <p class="text-sm font-medium text-slate-200">ข้อมูลหมวดหมู่</p>
                                <p class="mt-1 text-xs leading-5 text-slate-500">
                                    กรอกชื่อ slug ประเภท และคำอธิบายให้ชัดเจน
                                </p>
                            </div>

                            <div class="rounded-2xl border border-white/10 bg-slate-950/40 p-4">
                                <p class="text-sm font-medium text-slate-200">โครงสร้างลำดับชั้น</p>
                                <p class="mt-1 text-xs leading-5 text-slate-500">
                                    เลือกหมวดหมู่แม่ให้ถูกต้อง หากต้องการสร้างหมวดหมู่ย่อย
                                </p>
                            </div>
                            ...
                            <div class="rounded-2xl border border-white/10 bg-slate-950/40 p-4">
                                ...
                                <p class="mt-1 text-xs leading-5 text-slate-500">
                                    ตรวจสอบสถานะ ลำดับ และการตั้งค่าแนะนำก่อนบันทึก
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="sticky bottom-0 z-20 -mx-2 rounded-t-3xl border border-white/10 bg-slate-950/90 px-4 py-4 shadow-2xl shadow-slate-950 backdrop-blur">
                <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <p class="text-xs text-slate-500">
                        ตรวจสอบข้อมูลหมวดหมู่ก่อนกดบันทึก
                    </p>
