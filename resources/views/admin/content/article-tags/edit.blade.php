<x-layouts.admin title="แก้ไขแท็กบทความ" header="แก้ไขแท็กบทความ">
        ...
        <div class="overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-slate-900 via-slate-900 to-indigo-950 shadow-xl shadow-slate-950/30">
            <div class="flex flex-col gap-6 p-6 lg:flex-row lg:items-center lg:justify-between">
                <div class="max-w-2xl">
                    ...
                    <h1 class="text-2xl font-bold text-white">แก้ไขแท็กบทความ</h1>

                    <p class="mt-2 text-sm leading-6 text-slate-400">
                        กำลังแก้ไข:
                        <span class="font-medium text-white">{{ $articleTag->name }}</span>
                    </p>
                </div>
                        ...
                        <div class="mt-4 space-y-3">
                            <div class="rounded-2xl border border-white/10 bg-slate-950/40 p-4">
                                ...
                                <p class="mt-1 text-xs leading-5 text-slate-500">
                                    แก้ไขชื่อแท็ก slug สถานะ และลำดับการแสดงผล
                                </p>
                            </div>

                            <div class="rounded-2xl border border-white/10 bg-slate-950/40 p-4">
                                <p class="text-sm font-medium text-slate-200">ผลต่อบทความ</p>
                                <p class="mt-1 text-xs leading-5 text-slate-500">
                                    การเปลี่ยนชื่อแท็กอาจส่งผลต่อการค้นหาและการกรองบทความ
                                </p>
                            </div>
                            ...
                            <div class="rounded-2xl border border-white/10 bg-slate-950/40 p-4">
                                ...
                                <p class="mt-1 text-xs leading-5 text-slate-500">
                                    ปิดใช้งานแท็กเมื่อต้องการหยุดใช้โดยไม่ลบข้อมูลเดิม
                                </p>
                            </div>
                        </div>
                    </div>
