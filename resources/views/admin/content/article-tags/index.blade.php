<x-layouts.admin title="จัดการแท็ก" header="จัดการแท็ก">
        ...
        <div class="rounded-3xl border border-white/10 bg-white/[0.04] p-5 shadow-lg shadow-slate-950/20 backdrop-blur">
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <h1 class="text-2xl font-bold text-white">จัดการแท็ก</h1>
                    <p class="mt-1 text-sm text-slate-400">
                        จัดการแท็กสำหรับจัดกลุ่ม ค้นหา และกรองในระบบ
                    </p>
                </div>
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <form
                                            ...
                                            onsubmit="return confirm('ยืนยันการลบแท็กนี้หรือไม่?');"
                                        >
                                            @csrf
                                            @method('DELETE')
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-5 py-10 text-center">
                                    <p class="text-base font-medium text-slate-300">ไม่พบแท็ก</p>
