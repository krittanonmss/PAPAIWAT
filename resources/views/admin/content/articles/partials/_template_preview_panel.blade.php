...
@if ($templatePreviewSrc)
    ...
    >
        <div class="border-b border-white/10 px-5 py-4">
            <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                <div>
                    <p class="text-xs font-semibold uppercase tracking-[0.18em] text-blue-300">Article Preview</p>
                    <h2 class="mt-1 text-lg font-semibold text-white">ตัวอย่างหน้าแสดงผลบทความ</h2>
        ...
        <div x-show="previewOpen" x-cloak class="relative h-[360px] bg-slate-950 md:h-[460px] xl:h-[560px]">
            <iframe
                ...
                title="ตัวอย่างหน้าแสดงผลบทความ"
    ...
    @once
        <script>
            (() => {
                const bindArticleTemplatePreview = () => {
                ...
                if (document.readyState === 'loading') {
                    document.addEventListener('DOMContentLoaded', bindArticleTemplatePreview);
                } else {
                    bindArticleTemplatePreview();
                }
            })();
        </script>
    @endonce
